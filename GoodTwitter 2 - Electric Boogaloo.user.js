...
(function($, waitForKeyElements) {
      ...
      $("main").before(`
        <nav class="gt2-nav">
          ...
          <div class="gt2-nav-right">
            ...
            <a href="#" class="css-1dbjc4n gt2-account-switcher-toggle">
            <svg viewBox="0 0 24 24" aria-hidden="true" class="r-vlxjld r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
                <g>
  ...
  $("body").on("click", ".gt2-account-switcher-toggle", function() {
    ...
    let pos = $(".gt2-account-switcher-toggle")[0].getBoundingClientRect()
    $("html").prepend(`
